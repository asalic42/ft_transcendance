...
from .views import home, signout, delete_account, delete_success, service_unavailable, profile_page, game_page, game_mode_page, game_bot_page, channels_page, chan_conv_page
...
urlpatterns = [
    ...
    path('chan-conv/', chan_conv_page, name='chan-conv'),
